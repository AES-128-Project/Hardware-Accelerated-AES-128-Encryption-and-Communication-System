`timescale 1ns/1ps
// AES SubBytes S-Box - complete NIST FIPS-197 Appendix A table
// All 256 entries verified against the standard

module aes_sbox (
    input  wire [7:0] in,
    output reg  [7:0] out   // reg for case statement - still combinational
);
    // Using always @(*) + case instead of array ROM
    // This is more simulator-friendly and avoids the generate/wire Z issue
    always @(*) begin
        case (in)
