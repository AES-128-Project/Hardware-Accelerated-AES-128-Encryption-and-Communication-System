...
module rfid_aes_uart_top (
    ...
    // Basys 3 Clock is 100 MHz. This ensures UART baud math is correct for 115200.
    ...
    // 4. UART TX to ESP32 (Using your original module parameters)
    uart_tx_128 #(
        .CLK_FREQ  (SYS_CLK_FREQ),
        .BAUD_RATE (BAUD_RATE)
    ) u_uart_tx (
